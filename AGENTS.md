...
- Keep this a build-free static site suitable for GitHub Pages. Do not add a framework, package manager, server, database, or third-party runtime unless the user explicitly asks.
